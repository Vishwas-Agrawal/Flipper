    ...
    <div className="App">
      <section className="hero">
        ...
        <div className="container">
          ...
          <div className="cta" onClick={HandleSubmit}>Login</div>
        </div>
      ...
      <section className="hero2">
        <div style={{ display: "flex" }}>
          <div className="emailimage1">
            <img src={emailhistory1} className="emailhistory1"></img>
          </div>
          <div className="h1div">
            <p>Email&nbsp;&nbsp;&nbsp;History</p>
          </div>
        ...
        <div style={{ display: "flex", marginTop: "5%" }}>
          ...
          <div style={{ marginRight: "5%" }} className="emailhistory2">
            <img src={emailhistory2} className="emailhistory2"></img>
          </div>
        </div>
      </section>
      <section className="hero3">
        <div style={{ display: "flex" }} className="tpoint">          
        <img src={leftimage} className="leftimage"></img>          
      ...
      <section className="hero4">
        <div style={{ display: "flex" }}>
          <div className="autoimage">
            <img src={autoleft} className="autoleft"></img>
          </div>
        ...
        <div style={{ display: "flex", marginTop: "5%" }}>
          ...
          <div style={{ marginRight: "5%" }} className="autoright">
            <img src={autoright} className="autorights"></img>
          </div>
        </div>
      </section>
      <Footer></Footer>
